...
urlpatterns = [
    ...
    path('abrir_notificacion/<idn>/<idp>', views.abrir_notificacion, name='abrir_notificacion'),
    ...
    path('editar_contraseña/<id>', views.editar_contraseña, name='editar_contraseña'),   
